...
check_gold gold-4dn-sa.txt          tests/input-4.txt /dev/null --cols=80 --show-additions -L left -L right
check_gold gold-dn5-sa.txt          /dev/null tests/input-5.txt --cols=80 --show-additions -L left -L right
